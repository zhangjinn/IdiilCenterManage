            ...
            <el-card class="box-card">
              <div class="rowBox cardTop">
                ...
                <el-form-item label="课程名称:" :label-width="formLabelWidth">
                  <span class="editInfo editClassName">因数与倍数</span>
                </el-form-item>
                <el-form-item label="课程目标:" :label-width="formLabelWidth">
                  <span class="editInfo editClassName">（一）知识与技能  理解因数和倍数的意义以及两者之间相互依存的关系，掌握找一个数的因数和倍数的方法，发现一个数的倍数、因数中最大的数、最小的数，及因数和倍数个数方面的特征。 
（二）过程与方法  通过整数的乘除运算认识因数和倍数的意义，自主探索和总结出求一个数的因数和倍数的方法。 
...
教学难点：自主探索有序地找一个数的因数和倍数的方法。
                ...
                <el-form-item label="对应版本:" :label-width="formLabelWidth">
                  <span class="editInfo editClassName">人教版</span>
                </el-form-item>
        ...
        <el-row>
          <el-col>
            <el-collapse>
              ...
              <!--<span class="editInfo editClassName">观察除法算式特点</span>-->
              <!--</el-form-item>-->
              <!--<el-form-item label="教学目标:" :label-width="formLabelWidth">-->
              <!--<span class="editInfo editClassName">探究除法算式的整除关系</span>-->
              <!--</el-form-item>-->
              <!--<el-form-item label="课程时长:" :label-width="formLabelWidth">-->
              <!--<span class="editInfo editClassName">100分钟</span>-->
              <!--</el-form-item>-->
